...
const DebugMenu: React.FC<DebugMenuProps> = ({ onSpawnEnemy, onSetWeapon, onLevelUp, onReset }) => {
  ...
  return (
    <div className="absolute top-20 right-4 w-64 bg-slate-900/90 border border-amber-500/30 text-slate-200 p-4 rounded-lg backdrop-blur-md shadow-2xl animate-in fade-in slide-in-from-right font-mono z-50">
